...
def vid_classification(input_video, feature_path):
    ...
    FeaturePath = FeaturePath + '.mp4.txt'
    ...
    while True:
        ...
        if (framescore > threshold):
            ...
            cv2.imwrite('{}/snippic{}.png'.format(snipdir, snip_n), frame)
            os.system(
                'ffmpeg -f image2 -framerate 30 -s {}x{} -start_number {} -i {}/%d.jpg -vcodec libx264 -profile:v high444 -refs 8 -crf 25 -preset ultrafast -pix_fmt yuv420p {}/snip{}.mp4'.format(
        ...
        if flag:
            ...
            jj=i%25
            if jj==1:
                plt.plot(x[:i], scoressmoothed[:i], color='r', linewidth=2)
                plt.draw()
